<div <?php print $attributes; ?>>
  ...
  <?php if ($display_submitted && !$page): ?>
    <div class="meta submitted">
      ...
      <?php
        print t('Posted by !username on !datetime',
          array('!username' => $name, '!datetime' => $date));
      ?>
    </div>
  <?php endif; ?>
...
// Only display the wrapper div if there are links.
    ...
    <div class="share-links">
      ...
      <a href="mailto:?subject=Discussion&body='<?php print $GLOBALS['base_url'].$node_url; ?>'"><img style="vertical-align: middle;" src="/sites/all/themes/j_alz/images/Mail_20px.svg" alt="E-mail Icon" height="20" width="20" /></a>
